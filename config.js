...
const VERIFY_CATEGORY_ID = process.env.VERIFY_CATEGORY_ID;
  ...
  embeds: {
    help: {
      ...
      fields: {
        ...
        verifyCommandName: '⚙️ วิธียืนยันสลิป',
        verifyCommandValue:
          'กดปุ่ม "🚀 เริ่มการยืนยัน" ที่ข้อความนี้ได้เลย บอทจะสร้างช่องส่วนตัวสำหรับอัพโหลดสลิปให้คุณ\n\nธนาคาร กสิกรไทย\nเลขบัญชี 123-4-56789-0\nชื่อบัญชี นายสมชาย ใจดี\n\n**🚨 โปรดระวังบอทจะไม่มีการทักหาส่วนตัวเพื่อขอข้อมูลใดๆ** 🚨',
      },
    },
...
if (!VERIFY_CATEGORY_ID) {
  console.warn('[System] ไม่ได้ตั้งค่า VERIFY_CATEGORY_ID ใน .env (ระบบ /verify ticket จะใช้ไม่ได้)');
}
